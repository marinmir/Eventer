...
class EventsLoaderMock: EventsLoader {
    func loadSearchResults(searchText: String, completion: @escaping ([Event]) -> Void) {
        ...
        let events2 = [Event(id: 2, title: "Work", place: "In office", dateTime: Date(), cost: 50, description: "pizdui rabotai bleat", titleImage: titleImage, visitors: visitors),
        ...
        Event(id: 4, title: "Hard Work", place: "Home", dateTime: Date(), cost: 60, description: "have a relax at home", titleImage: titleImage, visitors: visitors)]
